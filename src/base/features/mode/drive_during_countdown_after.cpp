...
namespace base
{
	void features::mode::drive_during_countdown_after(RaceSys::ModeManagerBase *mode_manager_base, RaceSys::ModeManagerBase::ERaceState original)
    {
        if (g_menu->m_drive_during_countdown_entry->IsActivated())
        {
