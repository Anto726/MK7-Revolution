...
namespace base
{
	...
	:
		...
		m_Item_ItemObjBase_setStateSelfMove("Item::ItemObjBase::setState_SelfMove", g_pointers->m_Item_ItemObjBase_setStateSelfMove, reinterpret_cast<void *>(&hook_funcs::Item_ItemObjBase_setStateSelfMove)),
		...
		m_Net_NetworkEngine_sendUnreliableCore("Net::NetworkEngine::sendUnreliableCore", g_pointers->m_Net_NetworkEngine_sendUnreliableCore, reinterpret_cast<void *>(&hook_funcs::Net_NetworkEngine_sendUnreliableCore)),
    ...
    void hooks::enable()
	{
		...
		m_Item_ItemObjBase_setStateSelfMove.enable();
		...
		m_Net_NetworkEngine_sendUnreliableCore.enable();
	...
	void hooks::disable()
	{
		...
		m_Net_NetworkEngine_sendUnreliableCore.disable();
		...
		m_Item_ItemObjBase_setStateSelfMove.disable();
